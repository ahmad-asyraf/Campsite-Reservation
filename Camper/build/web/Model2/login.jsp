<%-- 
    Document   : login
    Created on : 14 Jun 2022, 12:22:21 am
    Author     : Asyraf
--%>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="container pt-5 pb-5">
                ...
                %>
                <h1 class="text-center header-booking d-none d-sm-block">Sign In</h1>
                <form action="<%= request.getContextPath()%>/ControllerServlet" method="POST">
                    <div class="kotak col-md-5 text-center pt-md-5">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="action" value="userValidation">
                            <button type="submit" class="btn btn-primary col-12 col-md-3">Sign in</button>
                        </div>
                        <div class="form-group">
                            Doesn't own an account? <a href="<%= request.getContextPath()%>/Model2/create-account.jsp">Create account</a> 
                        </div>
                    </div>
                </form>
            </div>
